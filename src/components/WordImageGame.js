...
function ColorGame() {
  ...
  const [showEnglishTitle, setShowEnglishTitle] = useState(false); // Toggle title language
  ...
  const generateQuestion = () => {
    ...
    setShowHint(false);
    setShowEnglishTitle(false); // Reset to Bisaya
  };
    ...
    <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      {!showResult ? (
        ...
        <div className="text-center">
          ...
          <p className="text-xl">Your score: {localScore} out of {totalQuestions}</p>
          <button
