...
import refImage from "../assets/images/ref.png";

const words = [
  { name: "sakyanan", image: carImage }, // Car
  { name: "mansanas", image: appleImage }, // Apple
  { name: "silya", image: chairImage }, // chair
  { name: "pridyider", image: refImage }, // chair
];
...
function WordImageGame() {
  ...
  const generateQuestion = () => {
    ...
    // Generate 4 options (may repeat since only 2 words)
